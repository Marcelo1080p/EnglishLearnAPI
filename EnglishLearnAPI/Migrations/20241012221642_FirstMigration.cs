        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Quizzes_Courses_CourseModelCourseId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuizId = table.Column<int>(type: "int", nullable: false),
                    QuizModelQuizId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Questions", x => x.QuestionId);
                    table.ForeignKey(
                        name: "FK_Questions_Quizzes_QuizModelQuizId",
                        column: x => x.QuizModelQuizId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questions_QuizModelQuizId",
                table: "Questions",
                column: "QuizModelQuizId");

            migrationBuilder.CreateIndex(
                name: "IX_Quizzes_CourseModelCourseId",
                table: "Quizzes",
